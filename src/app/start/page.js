        ...
        <div className="flex flex-col items-center justify-center">
            ...
            <h1 className="bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent font-baloo font-bold text-xl lg:text-2xl">Upgrade your typing skills with our interactive speed test!</h1>
                ...
                <div className="relative inline-block group content-wrapper items-center justify-center gap-8 max-w-7xl w-full m-6 select-none text-2xl font-bold font-baloo">
                    ...
                    <p className='mx-auto text-center relative group text-xl text-black font-bold border-2 border-blue-900 border-solid p-4 rounded-md'>{paras}
                    </p>
                ...
                <p className='text-xl font-bold text-black'>WPM: {wpm}</p>

                <button className='mt-6 px-6 py-3 bg-purple-400 hover:bg-purple-900 rounded-xl text-lg font-semibold transition-all hover:cursor-pointer' onClick={changeIndex}>{paras === input ? "Next" : "Skip"}</button>
